...
const FAQS = [
  {
    ...
    a: 'Toca el botón + en la pantalla de inicio o en la barra de pestañas inferior para agregar rápidamente una nueva transacción.',
  },
  {
    q: '¿Cómo restauro mi suscripción?',
    a: 'Ve a la pantalla de pago y toca "Restaurar compras" para restaurar una suscripción comprada anteriormente.',
  },
  {
    q: '¿Mis datos están respaldados?',
    a: 'Sí. Todos tus datos se sincronizan de forma segura con la nube y están disponibles en todos tus dispositivos.',
  },
  {
    q: '¿Cómo cancelo mi suscripción?',
    a: 'Ve a Configuración → Gestionar suscripción, o abre App Store → tu ID de Apple → Suscripciones.',
  },
  {
    q: '¿Cómo elimino mi cuenta?',
    a: 'Ve a Configuración → Eliminar cuenta. Esto eliminará permanentemente todos tus datos.',
  },
];
    ...
    <div style={{ fontFamily: 'var(--font-bricolage), system-ui, sans-serif', background: '#fff', color: '#111', minHeight: '100vh' }}>
      ...
      <main style={{ maxWidth: 640, margin: '0 auto', padding: '72px 24px 96px' }}>
        <div style={{ textAlign: 'center', marginBottom: 56 }}>
          <div style={{ display: 'inline-block', background: '#111', color: '#fff', fontSize: 11, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', padding: '5px 12px', borderRadius: 99, marginBottom: 20 }}>
            Soporte
          </div>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div>
              <div style={{ fontSize: 13, fontWeight: 600, color: '#111', marginBottom: 2 }}>Soporte por correo electrónico</div>
        ...
        <div>
          <h2 style={{ fontSize: 20, fontWeight: 700, letterSpacing: '-0.5px', margin: '0 0 4px' }}>Preguntas frecuentes</h2>
          <p style={{ fontSize: 14, color: '#999', margin: '0 0 24px' }}>Respuestas rápidas a preguntas comunes.</p>
      ...
      <footer style={{ borderTop: '1px solid #f0f0f0', padding: '32px 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 20 }}>
            <a href='/es/privacy' style={{ fontSize: 13, color: '#999', textDecoration: 'none' }}>Privacidad</a>
            <a href='/terms' style={{ fontSize: 13, color: '#999', textDecoration: 'none' }}>Términos</a>
            <a href='/es/support' style={{ fontSize: 13, color: '#111', fontWeight: 600, textDecoration: 'none' }}>Soporte</a>
          </div>
