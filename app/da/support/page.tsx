...
const FAQS = [
  {
    q: 'Hvordan tilføjer jeg en transaktion?',
    a: 'Tryk på +-knappen på startskærmen eller den nederste fanebjælke for hurtigt at tilføje en ny transaktion.',
  },
  {
    q: 'Hvordan gendanner jeg mit abonnement?',
    a: 'Gå til betalingsskærmen og tryk på "Gendan køb" for at gendanne et tidligere købt abonnement.',
  },
  {
    q: 'Er mine data sikkerhedskopieret?',
    a: 'Ja. Alle dine data synkroniseres sikkert til skyen og er tilgængelige på tværs af dine enheder.',
  },
  {
    q: 'Hvordan annullerer jeg mit abonnement?',
    a: 'Gå til Indstillinger → Administrer abonnement, eller åbn App Store → dit Apple ID → Abonnementer.',
  },
  {
    q: 'Hvordan sletter jeg min konto?',
    a: 'Gå til Indstillinger → Slet konto. Dette vil permanent fjerne alle dine data.',
  },
];
    ...
    <div style={{ fontFamily: 'var(--font-bricolage), system-ui, sans-serif', background: '#fff', color: '#111', minHeight: '100vh' }}>
      ...
      <main style={{ maxWidth: 640, margin: '0 auto', padding: '72px 24px 96px' }}>
        <div style={{ textAlign: 'center', marginBottom: 56 }}>
          <div style={{ display: 'inline-block', background: '#111', color: '#fff', fontSize: 11, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', padding: '5px 12px', borderRadius: 99, marginBottom: 20 }}>Support</div>
          <h1 style={{ fontSize: 'clamp(32px, 5vw, 46px)', fontWeight: 800, letterSpacing: '-1px', lineHeight: 1.1, margin: '0 0 14px' }}>Hvordan kan vi hjælpe?</h1>
          <p style={{ fontSize: 16, color: '#666', lineHeight: 1.65, margin: 0 }}>Har du et spørgsmål eller problem? Kontakt os, og vi vender tilbage hurtigst muligt.</p>
        </div>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div>
              <div style={{ fontSize: 13, fontWeight: 600, color: '#111', marginBottom: 2 }}>E-mail support</div>
        ...
        <div>
          <h2 style={{ fontSize: 20, fontWeight: 700, letterSpacing: '-0.5px', margin: '0 0 4px' }}>Ofte stillede spørgsmål</h2>
          <p style={{ fontSize: 14, color: '#999', margin: '0 0 24px' }}>Hurtige svar på almindelige spørgsmål.</p>
      ...
      <footer style={{ borderTop: '1px solid #f0f0f0', padding: '32px 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 20 }}>
            <a href='/da/privacy' style={{ fontSize: 13, color: '#999', textDecoration: 'none' }}>Privatliv</a>
            <a href='/terms' style={{ fontSize: 13, color: '#999', textDecoration: 'none' }}>Vilkår</a>
            <a href='/da/support' style={{ fontSize: 13, color: '#111', fontWeight: 600, textDecoration: 'none' }}>Support</a>
          </div>
