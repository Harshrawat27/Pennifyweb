...
const FAQS = [
  {
    q: 'Hur lägger jag till en transaktion?',
    a: 'Tryck på +-knappen på hemskärmen eller i den nedre flikfältet för att snabbt lägga till en ny transaktion.',
  },
  {
    q: 'Hur återställer jag mitt abonnemang?',
    a: 'Gå till betalningsskärmen och tryck på "Återställ köp" för att återställa ett tidigare köpt abonnemang.',
  },
  {
    q: 'Är mina data säkerhetskopierade?',
    a: 'Ja. Alla dina data synkroniseras säkert till molnet och är tillgängliga på alla dina enheter.',
  },
  {
    q: 'Hur avbryter jag mitt abonnemang?',
    a: 'Gå till Inställningar → Hantera abonnemang, eller öppna App Store → ditt Apple ID → Prenumerationer.',
  },
  {
    q: 'Hur tar jag bort mitt konto?',
    a: 'Gå till Inställningar → Ta bort konto. Detta tar permanent bort alla dina data.',
  },
];
    ...
    <div style={{ fontFamily: 'var(--font-bricolage), system-ui, sans-serif', background: '#fff', color: '#111', minHeight: '100vh' }}>
      ...
      <main style={{ maxWidth: 640, margin: '0 auto', padding: '72px 24px 96px' }}>
        <div style={{ textAlign: 'center', marginBottom: 56 }}>
          ...
          <h1 style={{ fontSize: 'clamp(32px, 5vw, 46px)', fontWeight: 800, letterSpacing: '-1px', lineHeight: 1.1, margin: '0 0 14px' }}>Hur kan vi hjälpa?</h1>
          <p style={{ fontSize: 16, color: '#666', lineHeight: 1.65, margin: 0 }}>Har du en fråga eller ett problem? Kontakta oss så återkommer vi så snart som möjligt.</p>
        </div>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div>
              <div style={{ fontSize: 13, fontWeight: 600, color: '#111', marginBottom: 2 }}>E-postsupport</div>
        ...
        <div>
          <h2 style={{ fontSize: 20, fontWeight: 700, letterSpacing: '-0.5px', margin: '0 0 4px' }}>Vanliga frågor</h2>
          <p style={{ fontSize: 14, color: '#999', margin: '0 0 24px' }}>Snabba svar på vanliga frågor.</p>
      ...
      <footer style={{ borderTop: '1px solid #f0f0f0', padding: '32px 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 20 }}>
            <a href='/sv/privacy' style={{ fontSize: 13, color: '#999', textDecoration: 'none' }}>Integritet</a>
            <a href='/terms' style={{ fontSize: 13, color: '#999', textDecoration: 'none' }}>Villkor</a>
            <a href='/sv/support' style={{ fontSize: 13, color: '#111', fontWeight: 600, textDecoration: 'none' }}>Support</a>
          </div>
